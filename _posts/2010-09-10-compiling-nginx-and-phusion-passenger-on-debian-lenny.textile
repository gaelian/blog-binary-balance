...
---
After "compiling Ruby 1.9.2 on my Debian Lenny web server":/2010/08/28/compiling-ruby-1-9-2-on-debian-lenny, the next thing I wanted to do was get an actual web server going for serving up Rails apps. I've been an Apache user for a long time but I'd been hearing about "Nginx":http://nginx.org/ and how it's kicking ass and taking names, so I thought I might give it a go. I also needed some way to hook Rails up with Nginx.<!-- :truncate: -->
...
h3. Enough with the history lesson, get on with it god damnit!
...
h3. If you wanna be a passenger
