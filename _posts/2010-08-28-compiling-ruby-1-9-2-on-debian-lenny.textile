...
bq. The standard library is installed in /usr/local/lib/ruby/1.9.1

Seems a bit weird, but OK. Yay for backwards compatibility I guess?

h3. Note about RubyGems
...
h3. Forward, not backward, upward, not forward and always twirling, twirling, twirling towards freedom
...
The libc6-dev package _should_ be already installed on Debian Lenny. But I thought I'd list it anyway.
...
h3. Obsessive compulsive software compilation
