...
enki_id: 22
categories: chrome-extensions, chrome, firefox, open-source
---
In "my previous post":/2011/10/03/it-is-time-to-chrome-my-web-browsing I wrote about how I have now made the switch - full time - to Chrome as my default web browser. I'd just about managed to sort out all the extra functionality I needed from existing Chrome extensions, but there was one little Firefox Add-on that I found myself missing, it's called "Backpack Pages":https://addons.mozilla.org/en-US/firefox/addon/backpack-pages/ written by "Ben Mills":http://www.millssoftware.com/.<!-- :truncate: -->
